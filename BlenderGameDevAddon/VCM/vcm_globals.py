...
# defines the indevidual vertex channels 
...
#defuine all data layers and adds them into a list 
...
# compiles all vertex color channels into a enumarator 
...
# compiles all brush modes channels into a enumarator 
...
# compiles all blend modes channels into a enumarator 
